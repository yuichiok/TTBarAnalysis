...
namespace TTBarProcessor 
{
	...
	void TreeWriter::InitializeStatsBBBarTree(TTree * _hTree, StatsData & data)
	{
		...
		_hTree->Branch("ThrustCos", &data._ThrustCos, "ThrustCos/F");
		_hTree->Branch("SumCos", &data._SumCos, "SumCos/F");
		...
		_hTree->Branch("maxPhotonAngle", &data._maxPhotonAngle, "maxPhotonAngle/F");
